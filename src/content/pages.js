...
export const FEATURES = {
  'reduce-food-waste': {
    ...
    sections: [
      {
        ...
        bullets: [
          { title: 'Live expiry tracking', desc: 'Every item carries a use-by window you can adjust. Copantry flags what is close.' },
          { title: 'Best-before vs use-by', desc: 'Track both, so you use food at the right time instead of binning it early.' },
          { title: 'Nothing forgotten', desc: 'Items move up the list as their date approaches — the fridge stops hiding things.' },
        ],
      },
      {
    ...
    cta: { title: 'Start rescuing food tonight', subtitle: 'Free to start · no card needed. Add your kitchen and see what to cook before anything goes off.' },
  },
  ...
  'meal-planning': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          { title: 'Built around your pantry', desc: 'Uses what you own before it expires, so less gets wasted.' },
          { title: 'Scaled to your household', desc: 'Set how many you are feeding and quantities follow.' },
          { title: 'Shared with everyone', desc: 'The whole household sees and edits one plan in real time.' },
          { title: 'Leftovers tracked', desc: 'Cook once, and Copantry tracks the leftover portions for later.' },
        ],
      },
    ],
    faqKey: 'mealPlanning',
    related: [
      ...
      { label: 'Plan from your AI assistant', to: '/features/ai-assistant-mcp' },
    ],
  },
  ...
  'pantry-tracking': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          { title: 'Photo & receipt scanning', desc: 'AI turns a picture into dated pantry items.' },
          { title: 'Expiry estimates', desc: 'Copantry suggests a sensible use-by window for each item.' },
          { title: 'Soonest-to-expire first', desc: 'The things to use up are always at the top.' },
          { title: 'Shared across the home', desc: 'Everyone sees the same up-to-date kitchen.' },
        ],
      },
    ],
  ...
  'shopping-lists': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          { title: 'Auto-generated from your plan', desc: 'Plan meals, get exactly what you need to buy.' },
          { title: 'Aisle-sorted', desc: 'No doubling back across the store.' },
          { title: 'Real-time sharing', desc: 'Whoever is at the shop sees the live list.' },
          { title: 'Towards supermarket ordering', desc: 'Built to take the gaps all the way to checkout.' },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        bullets: [
          { title: 'Import from any URL', desc: 'Blogs, video sites and social posts included.' },
          { title: 'Photo & PDF import', desc: 'Turn a cookbook page or card into a real recipe.' },
          { title: 'Scales to your table', desc: 'Set servings and quantities adjust.' },
          { title: 'Stays multilingual', desc: 'A French recipe stays French; the app speaks your language.' },
        ],
      },
      {
  ...
  'for-families': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          { title: 'Shared plan & list', desc: 'Everyone sees the same week and shopping list, live.' },
          { title: 'Scaled to your family', desc: 'Recipes adjust to how many you are feeding.' },
          { title: 'Less waste, lower bill', desc: 'Plans use what you have before it expires.' },
          { title: 'Weaning-friendly', desc: 'Notes for adapting meals for babies and toddlers.' },
        ],
      },
    ],
    faqKey: 'forFamilies',
  ...
  'for-couples': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          { title: 'Real-time sync', desc: 'Both phones show the same kitchen instantly.' },
          { title: 'Two languages, one home', desc: 'Each person uses their preferred language.' },
          { title: 'Fewer trips & duplicates', desc: 'Shop once for exactly what you need.' },
          { title: 'Less waste together', desc: 'Use up what you both bought before it goes off.' },
        ],
      },
    ],
    faqKey: 'cookTogether',
  ...
  'budget-cooking': {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          { title: 'No duplicate buys', desc: 'It checks your pantry before adding anything.' },
          { title: 'Use-it-up meals', desc: 'Turn “about to expire” into dinner, not waste.' },
          { title: 'Plan to a budget', desc: 'Build the week around what you already have.' },
          { title: 'Less waste = real savings', desc: 'Households waste around £1,000 of food a year (WRAP).' },
        ],
      },
    ],
