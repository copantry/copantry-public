...
export const SHELF_LIFE = [
  {
    ...
    store:
      "Keep it dry in a loosely closed bag or box lined with kitchen paper to absorb moisture, in the fridge crisper drawer.",
  ...
  },
  {
    ...
    store:
      "Keep it in the coldest part of the fridge (usually the bottom shelf), sealed, and below other foods so it cannot drip.",
  ...
  },
  {
    ...
    store:
      "Store it on a fridge shelf, not the door, where the temperature is steadier and colder.",
  ...
  },
  {
    ...
    store:
      "Ripen at room temperature, then move to the fridge to slow it down. Keep a cut half with the stone in and lemon on top.",
  ...
  },
  {
    ...
    store:
      "Keep them out of the fridge until ripe; separating them slows ripening. Very ripe bananas freeze well.",
  ...
  },
  {
    ...
    store:
      "Keep them dry and unwashed in the fridge; only wash just before eating. Remove any mouldy ones immediately.",
  ...
  },
  {
    ...
    store:
      "Keep it in a bread bin at room temperature, or slice and freeze what you will not eat in a few days.",
  ...
  },
  {
    ...
    store:
      "Store them in the fridge in their box, pointed end down. A fresh egg sinks in water; a stale one floats.",
  ...
  },
  {
    ...
    store:
      "Keep them at room temperature out of the sun for best flavour; refrigerate only very ripe ones to buy a day or two.",
  ...
  },
  {
    ...
    store:
      "Keep them in the fridge crisper, ideally in a bag; remove leafy tops, which draw out moisture.",
  ...
  },
  {
    ...
    store:
      "Keep them in a cool, dark, airy place — not the fridge, which turns their starch to sugar. Away from onions.",
  ...
  },
  {
    ...
    store:
      "Store whole onions in a cool, dry, ventilated spot away from potatoes. Keep cut onions wrapped in the fridge.",
  ...
  },
  {
    ...
    store:
      "Wrap in baking paper then loosely in foil, in the fridge; this lets it breathe without drying out.",
  ...
  },
  {
    ...
    store:
      "Keep it on a cold fridge shelf and use a clean spoon to avoid introducing bacteria.",
  ...
  },
  {
    ...
    store:
      "Keep them in a paper bag in the fridge, not sealed plastic, so they can breathe.",
  ...
  },
  {
    ...
    store:
      "Keep it dry and loosely wrapped with kitchen paper in the crisper drawer.",
  ...
  },
  {
    ...
    store:
      "Keep them whole and dry in the fridge crisper; once cut, wrap and use within a few days.",
  ...
  },
  {
    ...
    store:
      "Keep it unwashed in the fridge, loosely bagged; a damp paper towel helps it stay crisp.",
  ...
  },
  {
    ...
    store:
      "Keep them in the fridge crisper, away from other fruit and veg they would over-ripen.",
  ...
  },
  {
    ...
    store:
      "Keep it on ice or in the coldest part of the fridge and cook it the day of, or day after, purchase.",
  ...
  },
  {
    ...
    store:
      "Stand soft herbs in a glass of water like flowers, loosely covered, in the fridge (basil prefers the counter).",
  ...
  },
  {
    ...
    store:
      "Keep it wrapped in the fridge; freeze spare blocks. A little in a covered dish at room temp is fine for daily use.",
  ...
  },
  {
    ...
    store:
      "Cool within two hours, store in a sealed container, and keep no more than 2–3 days — or freeze for later.",
