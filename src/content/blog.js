...
export const POSTS = [
  {
    ...
    description: 'A simple method for turning whatever is already in your fridge into a real dinner tonight — no shopping trip required.',
    emoji: '🍳',
    category: 'Cooking',
    date: '2026-06-02',
    readMins: 5,
  },
  {
    ...
    title: 'How much food does the average UK household waste — and the 5 things we bin most',
    description: 'What the data from WRAP actually says about household food waste in the UK, the foods we throw away most, and what it costs you.',
    emoji: '📊',
    category: 'Food waste',
    date: '2026-05-20',
    readMins: 6,
  },
  {
    ...
    title: 'The use-it-up method: plan meals around your fridge, not a recipe book',
    description: 'Most meal planning starts with a recipe and sends you shopping. Flip it: start with what you already have. Here is the method.',
    emoji: '🧊',
