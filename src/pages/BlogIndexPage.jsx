      ...
      <Section className="hero-gradient pt-16 pb-12 md:pt-20 md:pb-16" width="max-w-3xl">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed">
            Practical, no-nonsense guides to cooking what you have, planning around your fridge, and
          ...
          {posts.map((post) => (
            ...
            >
              <div className="flex items-start gap-4">
                <span className="text-3xl shrink-0" aria-hidden="true">{post.emoji}</span>
                <div>
                  <p className="text-xs font-black text-orange-500 uppercase tracking-widest mb-1">{post.category} · {post.readMins} min read</p>
                  <h2 className="text-lg md:text-xl font-extrabold text-gray-900 group-hover:text-orange-600 leading-snug">{post.title}</h2>
