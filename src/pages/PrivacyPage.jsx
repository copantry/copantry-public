    ...
    <div className="max-w-3xl mx-auto px-4 py-16 md:py-24">
      ...
      <div className="mb-12">
        ...
        <div className="mt-4 p-4 bg-blue-50 border border-blue-100 rounded-xl text-sm text-blue-800">
          This policy explains what personal data CoPantry collects, why, and what rights you have over it. We have tried to write it in plain language. If you have questions, contact us at{' '}
          <button
      ...
      <Section id="who-we-are" title="1. Who we are">
        <P>CoPantry ("CoPantry", "we", "our", "us") is the operator of the recipe and meal-planning service available at <strong>app.copantry.com</strong> and the marketing site at <strong>www.copantry.com</strong>.</P>
        <P>For the purposes of the UK GDPR and EU GDPR, CoPantry is the data controller for personal data collected through these services.</P>
      </Section>

      <Section id="what-we-collect" title="2. What data we collect">
        <P><strong>Account data</strong> — when you register, we collect your email address, display name, and a securely hashed version of your password. We never store your password in readable form.</P>
        <P><strong>Content data</strong> — recipes (titles, ingredients, instructions, photos), pantry items, meal calendar entries, shopping lists, and household memberships that you create or import.</P>
        <P><strong>AI provider credentials</strong> — if you choose to provide a Google Gemini API key to unlock AI features, that key is stored in encrypted form in our database. We decrypt it only at the moment it is needed to process your request, and we never log or display it.</P>
        <P><strong>Usage data</strong> — counts of API calls made against your plan (for plan-limit enforcement), and the timestamps of actions such as recipe imports. We do not build detailed behavioural profiles.</P>
        <P><strong>Technical data</strong> — IP addresses and basic HTTP request metadata are captured in server logs for security and diagnostic purposes. Log retention is limited to 30 days.</P>
        <P><strong>Language preference</strong> — if you accept our cookie notice on www.copantry.com, we store your chosen language in your browser's localStorage. This is not transmitted to our servers.</P>
      </Section>
      ...
      <Section id="how-we-use" title="3. How we use your data">
        ...
        <P>We do not use your content data for advertising, and we do not sell your data to third parties.</P>
      </Section>

      <Section id="third-parties" title="4. Third-party processors">
        <P>We share data with the following categories of third-party processors where necessary to operate the service:</P>
        <UL items={[
        ...
        <P>We do not transfer personal data outside the UK/EEA without appropriate safeguards (such as Standard Contractual Clauses where required).</P>
      </Section>
      ...
      <Section id="your-rights" title="7. Your rights">
        ...
        <P>To exercise any of these rights, contact us at info@copantry.com. We will respond within 30 days. If you are unsatisfied with our response, you have the right to lodge a complaint with your national data protection authority (e.g. the ICO in the UK, or your local EU supervisory authority).</P>
      </Section>

      <Section id="security" title="8. Security">
        <P>We implement technical and organisational measures to protect your data, including password hashing (bcrypt), encrypted storage of API keys, TLS encryption in transit, and access controls on our infrastructure.</P>
        <P>No method of transmission over the internet or electronic storage is completely secure. We cannot guarantee absolute security, and we encourage you to use a strong, unique password and to keep your API keys confidential.</P>
      </Section>

      <Section id="children" title="9. Children">
        <P>CoPantry is not directed at children under 16. We do not knowingly collect personal data from anyone under 16. If you believe a child has provided us with personal data, please contact us and we will delete it promptly.</P>
      </Section>

      <Section id="changes" title="10. Changes to this policy">
        <P>We may update this policy from time to time. When we make material changes, we will update the "Last updated" date at the top of this page and, where appropriate, notify you by email. Continued use of the service after changes take effect constitutes acceptance of the updated policy.</P>
      </Section>
