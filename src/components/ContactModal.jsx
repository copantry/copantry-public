...
const CONFIG = {
  contact: {
    title: "Get in touch",
    intro:
      "We'd love to hear from you. We typically reply within 1–2 business days.",
    messagePlaceholder: "What can we help you with?",
  },
  investors: {
    title: "Investor enquiry",
    intro:
      "Interested in CoPantry? Tell us about yourself and we'll be in touch.",
    messagePlaceholder:
...
export default function ContactModal({ type, onClose }) {
  ...
  const inputCls =
    "w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400/40 focus:border-orange-400 transition bg-white";
            ...
            <form onSubmit={submit} noValidate className="space-y-3.5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span
                    className={`text-xs ${remaining < 100 ? "text-orange-500" : "text-gray-400"}`}
                  >
                    {remaining} left
                  </span>
                </div>
